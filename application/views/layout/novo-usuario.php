...
<body>
 <div class="container">
        ...
        <?php echo form_open(base_url("usuarios/salvar"), array('method' => 'POST', 'class'=> 'form-signin')); ?>
        ...
        <label for="inputEmail" class="sr-only">Primeiro nome </label>

        <?php echo form_input('nome', set_value('nome'), 'placeholder= "Digite o seu nome" class="form-control espaco" required autofocus');?>
        ...
        <div style = "padding-top: 20px;">
        	<?php echo anchor('usuarios/login', 'Já possui cadastro? clique aqui'); ?>
      	</div>
